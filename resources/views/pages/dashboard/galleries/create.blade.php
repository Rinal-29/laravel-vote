<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Locations &raquo; {{ $locations->name }} &raquo; Gallery &raquo; Upload Photos
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('dashboard.locations.galleries.store', $locations->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
